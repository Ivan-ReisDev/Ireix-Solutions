...
- **SC-SEO**: [Search/crawl metric, e.g., "All indexable pages expose title, description,
  canonical URL, one H1, and Open Graph data"]
- **SC-PERF**: [Performance metric, e.g., "LCP remains under 2.5s on target pages in Lighthouse"]
- **SC-A11Y**: [Accessibility metric, e.g., "Keyboard and screen reader checks pass for the
  primary journey"]
